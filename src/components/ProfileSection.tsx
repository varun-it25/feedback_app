import { BadgeAlert, CircleGauge, Mail, MapPin, Phone, Sparkles, Star, StarHalf, User } from "lucide-react";

const ProfileSection = () => {
  return (
    <div className="hidden sm:block h-full w-[21rem] py-4">
        <div className="h-full w-full px-2 py-4 rounded-xl border shadow-md">
            <div className="space-y-4 flex-col px-2 flex items-center w-full h-full overflow-auto overflow-x-hidden">
                    ...
                    <div className="w-full">
                        ...
                        <div className="space-y-3.5 mt-2 p-1">
                            ...
                            <div className="flex items-center space-x-2">
                                <div className="flex-1 text-xs font-medium border px-2 py-1.5">
                    ...
                    <div className="w-full">
                        ...
                        <div className="space-y-2 mt-2">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <div className="text-xs font-medium px-2 py-0.5 bg-zinc-100 rounded border">2 Yrs</div>
                          </div>
                    ...
                    <div className="flex items-center space-x-3 border rounded-lg p-2 pr-4.5">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-center">
                              ...
                              <div className="text-xs font-medium px-2 py-0.5 bg-zinc-100 rounded border">1 Yrs</div>
                            </div>
